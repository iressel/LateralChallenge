...
- Use block bodies for ordinary methods, constructors, operators and conversion operators, and local functions; expression-bodied properties, accessors, and lambdas remain permitted.
